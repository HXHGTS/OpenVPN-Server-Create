...
#truncate -s 0 /root/vpnserver/packet_log/**/*.log


#Ensure security logs are cleared if they ever get enabled
#truncate -s 0 /root/vpnserver/security_log/**/*.log

#Ensure softether server logs are cleared if they ever get enabled
#truncate -s 0 /root/vpnserver/server_log/*.log

#Delete softether empty log file names
find /root/vpnserver/ -name '*.log' -delete
